...
class LoadData(): #This class will be used to handle the dataset, the vocabulary and the dataloaders
    ...
    def __read_file(self, path, eos_token="<eos>"): #Read the file containing the dataset
        output = []
    ...
    def get_dataset_loaders(self, batch_size_train=64, batch_size_val=128, batch_size_test=128, pad_token="<pad>"): #Return the dataloaders
